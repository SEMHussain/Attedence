...
public class InOut extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(eid, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 197, 29));
        ...
        getContentPane().add(msg, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 197, 39));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 15)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("ID");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 99, 39, 30));
    ...
    private void msgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_msgActionPerformed
        try {
            ...
            SimpleDateFormat sdf2 = new SimpleDateFormat("hh:mm:ss");
                ...
                Logger.getLogger(InOut.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
